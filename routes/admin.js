...
// const { updateUserPlan, getFileExtension, sendEmail, getUserSignupsByMonth, getUserOrderssByMonth, isValidEmail } = require('../functions/function.js')
...
//     try {
//         const { title, short_description, allow_tag, allow_note, allow_chatbot,
//             contact_limit, allow_api, is_trial, price, price_strike, plan_duration_in_days } = req.body

//         if (!title || !short_description || !plan_duration_in_days) {
//             return res.json({ success: false, msg: " Please fill details" })
//         }

//         await query(`INSERT INTO plan (title, short_description, allow_tag, allow_note, allow_chatbot,
...
//     try {
//         const { pay_offline_id, pay_offline_key, offline_active, pay_stripe_id, pay_stripe_key, stripe_active } = req.body

//         await query(`UPDATE web_private SET  pay_offline_id = ?, pay_offline_key = ?, offline_active = ?, pay_stripe_id = ?, pay_stripe_key = ?, stripe_active = ?`, [
//             pay_offline_id, pay_offline_key, offline_active, pay_stripe_id, pay_stripe_key, stripe_active
//         ])
...
//             return res.json({ success: true, msg: "We have sent a recovery link if this email is associated with admin account." })
//         }
