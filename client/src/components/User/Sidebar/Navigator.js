...
const categories = [
  ...
  },
  {
    ...
    children: [
      { id: "Phonebook", icon: <ContactPhoneIcon />, link: "/user/Phonebook" },
      { id: "Broadcast", icon: <BroadcastOnHomeIcon />, link: "/user/Broadcast" },
      { id: "Inbox", icon: <QuestionAnswerIcon />, link: "/user/Inbox" },
      { id: "More features", icon: <MoreIcon />, link: "/user/MoreFeature" },
    ],
  },
  {
    id: "Email Marketing",
